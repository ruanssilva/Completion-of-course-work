...
var LVSA = {
    ...
    CDN: {
        ...
        Configuration: {
            Server: "http://127.0.0.1/LVSA.CDN.Presentation/"
        },
        ...
        Plugins: {
            ...
            Inicialize: function () {
                ...
                if ($('input[data-mask*="$"]').length || $('input.maskmoney, input.maskdecimal').length) {
                ...
                $('a:not(".not-show-loading")').click(function () {
                    ...
                    var loading = href != null && href.trim() != '#' && href.trim() != '#' && href.split('')[0] != '#' && href != "javascript:void(0);" && target != "_blank" && href.indexOf("mailto") == -1;
            ...
            Mask: function () {
                $.getScript(LVSA.CDN.Configuration.Server + "Content/Templates/Ace/assets/js/jquery.maskedinput.js", function () {
                    $('input[data-mask*="$"]:not(.load)').each(function () {
                ...
                $.getScript(LVSA.CDN.Configuration.Server + "Content/Plugins/MaskMoney/jquery.maskMoney.min.js", function () {
                    $('input[type="text"].maskmoney:not(.load), input[type="text"].maskdecimal:not(.load)').each(function () {
                        $(this).maskMoney({
                            suffix: $(this).data('suffix'),
                            prefix: $(this).data('prefix'),
                            precision: $(this).data('precision') != null ? $(this).data('precision') : 2,
                            thousands: '',
                            decimal: ',',
                            affixesStay: false,
                            allowZero: true
            ...
            Chosen: function () {
                $.getScript(LVSA.CDN.Configuration.Server + "Content/Templates/Ace/assets/js/chosen.jquery.js", function () {
                    $('.chosen-select:not(.load)').each(function (element, indice) {
                        $(this).addClass('load');
