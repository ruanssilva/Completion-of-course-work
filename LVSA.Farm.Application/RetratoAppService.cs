...
{
    public class RetratoAppService : AppServiceBase<RetratoViewModel,Retrato,IRetratoService>, IRetratoAppService
    {
        public RetratoAppService(IRetratoService retratoService)
            : base(retratoService)
        {
