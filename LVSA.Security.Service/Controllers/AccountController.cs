...
using LVSA.Security.Service.Providers;
using LVSA.Security.Service.Results;
...
namespace LVSA.Security.Service.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            AppIdentityUser user = await UserManager.FindAsync(new UserLoginInfo(externalLogin.LoginProvider,
