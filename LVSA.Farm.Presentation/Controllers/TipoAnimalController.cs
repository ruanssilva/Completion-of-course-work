...
namespace LVSA.Farm.Presentation.Controllers
{
    public class TipoAnimalController : ControllerBase
    {
        ...
        public TipoAnimalController(ITipoAnimalAppService tipoAnimalAppService)
        {
        ...
        protected override void Initialize(System.Web.Routing.RequestContext requestContext)
        {
            ...
            {
                _tipoAnimalAppService.SetSeguranca(Contexto.Seguranca);
            }
        }
        ...
        public ActionResult Index()
        {
            try
            {
                var model = _tipoAnimalAppService.Todos();
        ...
        public ActionResult Details(int id)
        {
            try
            {
                var model = _tipoAnimalAppService.Filtrar(f => f.Id == id).SingleOrDefault();
                if (model == null)
        ...
        [HttpPost]
        public ActionResult Create(TipoAnimalViewModel model, HttpPostedFileBase[] FileSet)
        {
            try
            {
                ...
                _tipoAnimalAppService.Incluir(model);
        ...
        [HttpPost]
        public ActionResult Edit(int id, TipoAnimalViewModel model, HttpPostedFileBase[] FileSet)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                _tipoAnimalAppService.Atualizar(model);
        ...
        [HttpPost]
        public ActionResult Delete(int id, TipoAnimalViewModel model)
        {
            try
            {
                var _model = _tipoAnimalAppService.Filtrar(f => f.Id == id).SingleOrDefault();
                if(_model == null)
                    throw new NoRecordsFoundException("Registro não encontrado");

                _tipoAnimalAppService.Remover(model);
